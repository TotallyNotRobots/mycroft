...
def deal_with_it(text, message) -> None:
...
def face_palm(text, message) -> None:
...
def head_desk(text, message) -> None:
...
def my_fetish(text, message) -> None:
