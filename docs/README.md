...
### Folder Structure
 ...
 - User: The users folder holds all the documentation for setting up a new CloudBot client instance, as well as the required configurations and needed APIs/external software.
 - Dev: The devs folder contains documentation for developers who wish to get a reference of the CloudBot API and code paradigms.
